 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.r2RML.impl.iResourceImpl#getUriRef <em>Uri Ref</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.r2RML.impl.iResourceImpl#getQname <em>Qname</em>}</li>
 * </ul>
 *
 * @generated
 */
public class iResourceImpl extends MinimalEObjectImpl.Container implements iResource
{
  ...
  {
    return R2RMLPackage.Literals.IRESOURCE;
  }
  ...
  public void setUriRef(String newUriRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, R2RMLPackage.IRESOURCE__URI_REF, oldUriRef, uriRef));
  }
  ...
  public NotificationChain basicSetQname(Qname newQname, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, R2RMLPackage.IRESOURCE__QNAME, oldQname, newQname);
  ...
  public void setQname(Qname newQname)
  {
    if (newQname != qname)
    {
      ...
      if (qname != null)
        msgs = ((InternalEObject)qname).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - R2RMLPackage.IRESOURCE__QNAME, null, msgs);
      if (newQname != null)
        msgs = ((InternalEObject)newQname).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - R2RMLPackage.IRESOURCE__QNAME, null, msgs);
      msgs = basicSetQname(newQname, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, R2RMLPackage.IRESOURCE__QNAME, newQname, newQname));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case R2RMLPackage.IRESOURCE__QNAME:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case R2RMLPackage.IRESOURCE__URI_REF:
        return getUriRef();
      case R2RMLPackage.IRESOURCE__QNAME:
        return getQname();
    }
